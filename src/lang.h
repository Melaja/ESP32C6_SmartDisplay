...
static const Lang LANG_NL = {
  ...
  "Druk de knop om een\nTelegram-bericht te sturen\nnaar uw telefoon.",
  LV_SYMBOL_CALL " Zoek",
  LV_SYMBOL_CLOSE " Geen WiFi verbinding",
  LV_SYMBOL_CLOSE " Telegram niet ingesteld",
  "Signaal verzenden...",
  LV_SYMBOL_OK " Bericht verstuurd!",
  LV_SYMBOL_CLOSE " Fout token (401)",
  LV_SYMBOL_CLOSE " Fout chat ID (400)",
...
static const Lang LANG_EN = {
  ...
  LV_SYMBOL_CLOSE " Telegram not configured",
  "Sending signal...",
  LV_SYMBOL_OK " Message sent!",
  LV_SYMBOL_CLOSE " Wrong token (401)",
  LV_SYMBOL_CLOSE " Wrong chat ID (400)",
